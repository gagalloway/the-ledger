...
export default function App() {
  ...
  useEffect(() => {
    const bg = data?.theme === "dark" ? "#000000" : "#F2F2F7";
  ...
  return (
    <ThemeCtx.Provider value={C}>
      <div style={{ minHeight: "100vh", background: C.bg, fontFamily: SYS, color: C.label }}>
        ...
        <div style={{ maxWidth: 560, margin: "0 auto", padding: "calc(14px + env(safe-area-inset-top)) 16px calc(100px + env(safe-area-inset-bottom))" }}>
